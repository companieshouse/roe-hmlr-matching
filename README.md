...
The pyproject.toml and roe-hmlr-matching.py will be place in the effective root folder and you will need the inputs and outputs subfolders within the root folder. You will also need to create a config.json file to store your login details in order to access the database and extract the ROE data from CHIPS.
